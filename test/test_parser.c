...
void test_caricaSimulazione_SIM_PEZZI_B2_letto_correttamente( void )
{
    ...
    short int err;
        ...
        int letto = parser_caricaSimulazione( "Config/Layout/plant_config_layout1.txt", &sim, &err );
...
void test_caricaScenario_guasto_singolo( void )
{
     ...
     * dopo l'estensione a lista (vedi ScenarioConfig in parser.h). */
        int letto = parser_caricaScenario( "Config/Scenari/scenario_difficile_layout1.txt", &scenario, &err );
